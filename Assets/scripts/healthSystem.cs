...
public class HealthSystem : MonoBehaviour
{
    ...
    /// Get health DepletionRate
    /// Used for changing the bar rate of change so health and oxygen are seperate, the change is set in the oxygen system, not Health, it should be changed, for now it stays
   public float GetdepletionHealthRatePerSecond()
    {
